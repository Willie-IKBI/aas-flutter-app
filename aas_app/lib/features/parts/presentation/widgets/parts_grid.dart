...
class PartsGrid extends StatefulWidget {
  ...
  final Function(Part)? onPartSelected;
  final int? selectedPartId;

  @override
  State<PartsGrid> createState() => _PartsGridState();
}
...
class _PartsGridState extends State<PartsGrid> {
  ...
  @override
  void didUpdateWidget(PartsGrid oldWidget) {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return PartsListItem(
            part: part,
            isSelected: widget.selectedPartId == part.id,
