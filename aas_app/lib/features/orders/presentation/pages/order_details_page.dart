    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow('Current Stage', _order!.currentStage.toDisplayString()),
      ...
      child: Column(
        ...
        children: [
          ...
          if (_order!.equipmentType != null)
            _buildInfoRow('Equipment Type', _order!.equipmentType!),
          if (_order!.equipmentModel != null)
            _buildInfoRow('Equipment Model', _order!.equipmentModel!),
          if (_order!.equipmentSerialNumber != null)
            _buildInfoRow('Serial Number', _order!.equipmentSerialNumber!),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _buildInfoRow('Customer', _order!.customerName ?? 'Customer ID: ${_order!.customerId}'),
      ...
      child: Column(
        ...
        children: [
          ...
          if (_order!.salesRepId != null) ...[
            _buildInfoRow('Sales Rep', _order!.salesRepName ?? _order!.salesRepId!),
